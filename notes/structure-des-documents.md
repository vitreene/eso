...
Chaque story à besoin d'un élément "root" dans lequel elle sera placée.
Dans une story, un ou plusieurs éléments doivent etre placés avant le lancement des events.
Dans ce cas, une propriété "move" est utilisée dans la définition "initial" du Perso ; ceci à la place de la propriété "entry".
Cela passe par un "extend" du perso lors de l'instanciation.
...
- si le cast est _string_ :
  - ajouter un event _start-story_ :
    - le nom de l'event end précedent devient le start du suivant
- dans tous les cas
  - ajouter un event _end-story_ s'il n'y en a pas

Les events end :
channel main : end-_« nom de la story »_
...
- les placer à la main :
  - à la fin des eventtimes:
    {startAt:'end-story', channel: 'main', name:'end-_« nom de la story »_ }
...
projet
|- chapters
|- concept01.yml - [scene01, scene04, ...]
|- pratique02.yml - [scene02, scene04, ...]
|- evaluation.yml - [scenes10-11 ...]
|- scenes
|- shared.yml
|- scene01.yml
|- scene04.yml
